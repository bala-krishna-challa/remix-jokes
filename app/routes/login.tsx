...
export const action = async ({ request }: ActionArgs) => {
  ...
  const redirectTo = validateUrl(formData.get("redirectTo") as string);
    ...
    case "login": {
      ...
      if (!loggedInUser) {
        return badRequest({
          fieldErrors: null,
          fields,
          formError: "username and/or password are incorrect",
        });
      }
    ...
    case "register": {
      ...
      if (existedUser) {
        return badRequest({
          fieldErrors: null,
          fields,
          formError: `User with username ${existedUser.username} already exists`,
        });
      }
